...
0.7.5 (2020-11-24)
------------------
* Add common linters. (`#265 <https://github.com/ros2/examples/issues/265>`_)
...
* fix `#138 <https://github.com/ros2/examples/issues/138>`_ which caused problems on windows because it wasn't cross-platform (`#148 <https://github.com/ros2/examples/issues/148>`_)
* Minimal service and client (`#138 <https://github.com/ros2/examples/issues/138>`_)
* Contributors: Dirk Thomas, Mikael Arguedas, Morgan Quigley, William Woodall, dhood
